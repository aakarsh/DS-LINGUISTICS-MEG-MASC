...
uv run python \${PROJECT_ROOT}/scripts/1-run-single-subject.py --subject-id \$CURRENT_SUBJECT --max-workers 128 --word-feature-prefix-list part_of_speech  VerbForm  Tense
EOF
